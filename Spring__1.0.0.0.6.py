...
if namez=="c":
    ...
    with open(name, "rb") as binary_file:
        ...
        while assx<10:
            ...
            numberschangenotexist = []
            numbers = []
            if blockw==5 and lenf1<100000 or blockw==2000 and lenf1<100000:
                blockw=5
                blockw1=4
            elif blockw==2000 and lenf1>=100000 or blockw==5 and lenf1>=100000:
                blockw=2000
                blockw1=1999
            s=""
            blockw=blockw+1
            ...
            with open(namea, "ab") as f2:
                ...
                aqqd1=len(zzaax1)
                if blockw==6 and lenf1<100000 or blockw==2001 and lenf1<100000:
                    blockw=5
                    blockw1=4
                    wer="1"+wer
                elif blockw==2001 and lenf1>=100000 or blockw==6 and lenf1>=100000:
                    blockw=2000
                    blockw1=1999
                    wer="0"+wer
                if aqqd1>0:
                ...
                if lenf1<=sssssw and saaq==0 and qqqwz>=1000 or sssssw<=25 or qqqwz==2**30:
